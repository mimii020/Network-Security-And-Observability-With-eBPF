...
# scenario to test deny-all then allow-frontend-to-backend policies
# CONFLICT : despite applying allow-frontend-to-backend, no traffic is allowed because deny policies have higher priority
